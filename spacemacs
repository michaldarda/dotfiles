...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(pastelmac-theme color-theme-github)
...
values."
  ...
  (setq-default
   ...
   custom-file-variable "~/custom.el"
